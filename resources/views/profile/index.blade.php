                        ...
                        <div class="bg-white dark:bg-dark dark:text-light dark:border->primary border border-white shadow-lg  rounded-3xl p-4 m-4">
                            <div class="flex-none sm:flex">
                                <div class=" relative h-32 w-32   sm:mb-0 mb-3">
                                    <a href="{{route('b.show',['username'=>$buss->username])}}">
                                    <img src="{{$buss->avatar}}" alt="aji" class=" w-32 h-32 object-cover rounded-2xl">
>>>>>>> e898d1e3573b758bd51eb91352a82c68d3ab8ff1
...
=======
                                                <div class="w-full flex-none text-md  font-bold leading-none">{{$buss->name}}|<br><a href="{{route("b.show",["username"=>$buss->username])}}"><span class="text-info text-xs">{{"@".$buss->username}}</span></a></div>
